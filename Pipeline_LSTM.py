...
from keras.layers import Dense, LSTM, Dropout, LayerNormalization, Input
...
for river in rivers:
    ...
    for days_of_memory in n_days_to_analyze:
        ...
        for scenario, desired_columns in scenarios.items():
            ...
            #save figure
            plt.savefig('images/plots/LSTM/tests/test{}_{}_{}daysmemory.eps'.format(river, scenario, days_of_memory), format='eps', dpi=100)
            ...
            new_row = {'river':river,'scenario':scenario, 'model':'LSTM','stateful':'True', 'split':'TimeSeriesSplit', 'folds':folds, 'trials':trials,
            ...
            file_path = os.path.join(os.getcwd(), 'pipeline_test.csv') 
